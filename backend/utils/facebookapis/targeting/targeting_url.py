...
def update_url_total_visitor_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True, contain_list=[]):
    try:
...
def update_usage_time_top_customers(custom_audience_id, name, pixel_id, prefill=True, retention_days=30, input_percent=25, contain_list=[]):
    try:
        input_percent = int(input_percent)
        custom_audience = CustomAudience(custom_audience_id)
...
def update_url_and_addtocart_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                                                 addtocart_evnet_name="AddToCart", contain_list=[]):
    try:
        custom_audience = CustomAudience(custom_audience_id)
...
def update_url_and_purchase_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                                                purchase_event_name="Purchase", contain_list=[]):
    try:
        custom_audience = CustomAudience(custom_audience_id)
...
def update_url_and_non_purchase_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                                                    purchase_event_name="Purchase", contain_list=[]):
    try:
        custom_audience = CustomAudience(custom_audience_id)
...
def update_url_and_non_coversion_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                                                     conversion_event_name="ViewContent", contain_list=[]):
    try:
        custom_audience = CustomAudience(custom_audience_id)
