...
def update_purchase_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                              purchase_event_name="Purchase"):
    try:
...
def update_more_than_x_timtes_purchase_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                                                 purchase_evnet_name="Purchase", purchase_cnt=5):
    try:
        custom_audience = CustomAudience(custom_audience_id)
...
def update_more_than_x_amount_purchjase_customers(custom_audience_id, name, pixel_id, retention_days=30, prefill=True,
                                                  purchase_evnet_name="Purchase", minimum_val=5000):
    try:
